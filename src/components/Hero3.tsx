...
import DeliverabilityLimitModal from './DeliverabilityLimitModal';
...
const Hero3 = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-purple-50 to-blue-50 py-20 relative">
      <div className={modalOpen ? 'filter blur-sm pointer-events-none select-none' : ''}>
      ...
      <DeliverabilityLimitModal open={modalOpen} onClose={() => setModalOpen(false)} />
    </section>
  );
};

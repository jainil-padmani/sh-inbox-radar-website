...
const ResultPage = () => {
  ...
  const [activeTab, setActiveTab] = React.useState('deliverability'); // 'deliverability' or 'setup-analysis'
...
const ShareIcon = () => (
  <svg className="w-6 h-6 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.684 13.342C8.885 13.991 9 14.654 9 15.32c0 2.221-1.779 4-4 4s-4-1.779-4-4 1.779-4 4-4c.666 0 1.329.115 1.978.316m6.704-5.467c-.201-.649-.316-1.312-.316-1.978 0-2.221 1.779-4 4-4s4 1.779 4 4-1.779 4-4 4c-.666 0-1.329-.115-1.978-.316m-2.909 7.086c-2.457 1.054-4.887 2.05-7.143 2.975M4 15.32c0 2.221-1.779 4-4 4s-4-1.779-4-4 1.779-4 4-4c.666 0 1.329.115 1.978.316m6.704-5.467c-.201-.649-.316-1.312-.316-1.978 0-2.221 1.779-4 4-4s4 1.779 4 4-1.779 4-4 4c-.666 0-1.329-.115-1.978-.316m-2.909 7.086c-2.457 1.054-4.887 2.05-7.143 2.975m11.458-9.524c.201.649.316 1.312.316 1.978 0 2.221-1.779 4-4 4s-4-1.779-4-4 1.779-4 4-4c-.666 0-1.329-.115-1.978-.316"></path>
  </svg>
);

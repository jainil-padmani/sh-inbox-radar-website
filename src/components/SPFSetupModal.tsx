...
interface SPFSetupModalProps {
  isOpen: boolean;
  onClose: () => void;
  spfRecord?: string;
}

const SPFSetupModal: React.FC<SPFSetupModalProps> = ({ isOpen, onClose, spfRecord }) => {
  const record = spfRecord || 'v=spf1 a mx include:spf.sendinblue.com include:helpscoutemail.com include:_spf.google.com ~all';
  const handleCopy = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl max-w-lg w-full p-8 z-10">
        ...
        <h2 className="text-lg font-semibold mb-4">SPF Set-up</h2>
